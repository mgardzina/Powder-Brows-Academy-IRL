        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-serif text-marble-text mb-3 tracking-tight">
              Lip <span className="text-brand">Modeling</span>
            </h1>
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] p-6 md:p-8">
                ...
                <div className="bg-ui-bg p-6 rounded-xl border border-[#D4AF37] text-ui-textSecondary leading-relaxed space-y-4">
                  <p>
                    The lip modeling procedure is performed using hyaluronic
                    acid. It is an invasive treatment as it involves breaking
                    the continuity of the epidermis — and therefore it is not
                    without risk.
                  </p>
                  <p>
                    The procedure involves injecting a product via a needle into
                    the treated area. The goal is to enlarge the lips, hydrate
                    them, correct asymmetry, lift the corners of the mouth,
                    create the right proportion between the lips, and improve
                    the client's aesthetic appearance and wellbeing. The
                    introduced product is a transparent, biodegradable gel
                    containing hyaluronic acid of non-animal origin.
                  </p>
                  <p>
                    The procedure is always carried out after ruling out any
                    contraindications. During a consultation with the client,
                    their needs and expectations are established. The specialist
                    and client jointly determine the appropriate amount of
                    preparation to be administered during the procedure.
                  </p>
                  <p>
                    The next step is anesthesia, which minimizes discomfort
                    during the procedure. Pain threshold is perceived
                    individually. Anesthesia is applied to minimize pain, which
                    in most cases is effective. The duration of the procedure
                    depends on the application area and individual skin
                    characteristics, but on average takes about one hour. The
                    final result is visible 21 days after the procedure.
                  </p>
                  <p>
                    Lip modeling does not produce permanent effects; the result
                    lasts approximately 1 to 10 months and must be repeated. The
                    durability of the effect depends on skin type, the amount of
                    preparation injected, the injection technique, and
                    lifestyle. The average duration may be shorter due to strong
                    vascularization. The specialist informs the client that
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col gap-3">
                        {[
                          {
                            name: "Revolax Deep ",
                            desc: "A thicker gel that holds its shape very well. Recommended for clients expecting more pronounced lip augmentation or filling of nasolabial folds.",
                          },
                          {
                            name: "Neuramis Deep",
                            desc: "A pliable and soft gel. Ideal for clients who prefer a subtle, natural look (soft lips) and for smoothing moderate wrinkles.",
                          },
                        ].map((product) => {
                ...
                <div className="pt-8 mt-8 border-t border-brand/10">
                  <div className="bg-gradient-emerald p-5 rounded-xl border border-[#D4AF37] mb-6 space-y-4">
                    ...
                    <div className="space-y-3">
                      {[
                        "Lips modeled for the first time",
                        "Lips modeled a second time, at the same studio",
                        "Lips modeled a second time, first time at a different studio",
                      ].map((option) => (
                        <label
                          key={option}
                      ...
                      <div className="space-y-2">
                        <label className="flex items-start gap-3 cursor-pointer group">
                          <div className="relative flex items-center pt-1">
                            <input
                              ...
                              checked={(
                                formData.informacjaDodatkowa || ""
                              ).includes("Lips modeled multiple times")}
                              onChange={(e) => {
                                let parts = (
                                  formData.informacjaDodatkowa || ""
                                ).split("\n");
                                const prefix = "Lips modeled multiple times: ";
                                if (e.target.checked) {
                        ...
                        {(formData.informacjaDodatkowa || "").includes(
                          ...
                          <input
                            ...
                            placeholder="When, which product, how many times?"
                            value={
                              (formData.informacjaDodatkowa || "")
                                .split("\n")
                                .find((p) =>
                                  p.startsWith("Lips modeled multiple times: "),
                                )
                                ?.replace(
                                  "Lips modeled multiple times: ",
                                  "",
                            ...
                            onChange={(e) => {
                              ...
                              if (index !== -1) {
                                parts[index] =
                                  `Lips modeled multiple times: ${e.target.value}`;
                                handleInputChange(
                                  "informacjaDodatkowa",
                                  parts.join("\n"),
                                );
                      ...
                      <label className="flex items-start gap-3 cursor-pointer group pt-2 border-t border-[#D4AF37]/50">
                        <div className="relative flex items-center pt-1">
                          <input
                            ...
                            checked={(
                              formData.informacjaDodatkowa || ""
                            ).includes("Lips after hyaluronidase")}
                            onChange={(e) => {
                              let parts = (
                                formData.informacjaDodatkowa || ""
                              ).split("\n");
                              if (e.target.checked) {
                                parts.push("Lips after hyaluronidase");
                              } else {
                                parts = parts.filter(
                                  (p) => p !== "Lips after hyaluronidase",
                                );
                              }
                              handleInputChange(
                                "informacjaDodatkowa",
                ...
                <div className="bg-ui-bg p-5 rounded-xl border border-[#D4AF37] mb-6">
                  <p className="text-sm text-ui-textSecondary leading-relaxed mb-4">
                    <strong>
                      ...
                      necessity to follow the post-procedure care instructions
                      listed below:
                    </strong>
                  </p>
                  <ul className="space-y-2 text-sm text-ui-textSecondary">
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] shadow-lg p-6 md:p-8">
                ...
                <div className="bg-ui-bg p-5 rounded-xl mb-6 border border-[#D4AF37]">
                  <h4 className="font-serif text-marble-text text-lg mb-4">
                    DECLARATION AND INFORMED CONSENT FOR LIP MODELING /
                  ...
                  <div className="space-y-4 text-sm text-ui-textSecondary leading-relaxed">
                    <p>
                      ...
                      provided complete and truthful answers to questions about
                      my health. I declare that I have no medical, physical, or
                      psychological contraindications that could affect my
                      decision. At the time of signing this document, I am not
                      under the influence of alcohol, drugs, or other
                      intoxicating substances. I am making the decision to
                      undergo the procedure fully consciously, voluntarily, and
                      deliberately.
                    </p>
                    <p>
                      <strong>Procedure information and hygiene:</strong> I have
                      received comprehensive information about the procedure,
                      its technique, indications, and course. I had the
                      opportunity to ask questions and received understandable
                      answers. I confirm that the materials used (including the
                      pre-filled syringe with preparation) are sterile,
                      single-use, and were opened in my presence.
                    </p>
                    <p>
                      <strong>Risk and complications:</strong> I have been
                      informed of possible side effects such as swelling,
                      redness, bruising, and tenderness, which may persist for
                      several days. I am aware of the risk of an allergic
                      reaction to the anesthetic or injected preparation. I
                      accept this risk and will not make claims arising from my
                      body's individual response. I declare that, understanding
                      the risk of complications, I will not make compensation
                      claims in the event of typical procedure consequences or
                      complications of which I have been informed.
                    </p>
                    <p>
                      <strong>Effects and no guarantee:</strong> I have been
                      informed that the final result depends on individual
                      characteristics (biochemistry, skin type, tissue
                      plasticity, anatomical shape) and the amount of
                      preparation used. I acknowledge that results typically
                      last from 1 month to 1 year, which varies individually. I
                      understand that aesthetic medicine and cosmetology are not
                      exact sciences, and therefore no guarantee is given that
                      results will be identical to those of other clients, nor
                      for 100% satisfaction with the aesthetic outcome. A
                      discrepancy between my expectations and the actual result
                      (as determined by the Specialist) is not grounds for a
                      claim.
                    </p>
                    <p>
                      <strong>Post-procedure instructions:</strong> I commit to
                      strictly following the post-procedure recommendations that
                      have been communicated and explained to me. I understand
                      that failure to follow the instructions (e.g., hygiene,
                      avoiding certain factors) may lead to serious
                      complications such as infections, displacement of the
                      preparation, or scarring, for which the Specialist bears
                      no responsibility.
                    </p>
                    <p>
                      <strong>Qualifications of the practitioner:</strong> I
                      declare that I am fully aware that the Specialist
                      performing the procedure is not a medical doctor, but has
                      appropriate training and experience in performing
                      aesthetic treatments. I accept this fact.
                    </p>
