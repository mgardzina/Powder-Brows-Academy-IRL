        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-serif text-marble-text mb-3 tracking-tight">
              Eyelid <span className="text-brand">Lift</span>
            </h1>
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                  ...
                  <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-ui-bg border border-[#D4AF37] rounded-xl focus:border-brand focus:ring-2 focus:ring-brand/20 text-marble-text placeholder-marble-textSecondary outline-none transition-all"
                        placeholder="e.g. Example St. 1/2"
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] p-6 md:p-8 gold-glow-sm">
                ...
                <div className="prose prose-sm max-w-none text-ui-textSecondary leading-relaxed space-y-4">
                  <p>
                    Plazma PLEXR is an intelligent and safe device designed
                    primarily for eyelid lifting, allowing to achieve a
                    satisfactory effect after the first treatment. The Plasma
                    device generates a controlled and targeted micro plasma beam
                    thanks to the ionization of gases contained in the air. A
                    small electric arc is produced, which in a controlled manner
                    causes sublimation of the epidermis and thus shrinking of
                    the skin in the place of its action, resulting in lifting
                    the eyelids.
                  </p>
                  <p>
                    The treatment is performed pointwise without affecting the
                    surrounding tissues. It does not cause inflammation,
                    bleeding or damage to the surrounding tissues, because its
                    action is limited to the boundary of the basal layer of the
                    dermis.
                  </p>
                  <p>
                    <strong>Indications:</strong> Sagging upper/lower eyelids
                    (non-invasive blepharoplasty), eye area wrinkles, mouth
                    wrinkles (so-called "smoker's wrinkles"), at the ears, neck
                    and cleavage wrinkles, skin laxity (elbows, knees, abdomen
                    area), skin lesions (xanthelasma, fibromas, warts, solar
                    lentigo, actinic keratosis, warts).
                  </p>
                  <p>
                    <strong>Treatment description:</strong> The procedure
                    consists of performing small points on the skin surface
                    using plasma generated from the Plasma PLEXR device. During
                    the procedure, the needle does not touch the skin; it is in
                    close proximity to the treated area. Sublimation points are
                    placed at a distance of approx. 0.5 mm from each other. They
                    cause 'evaporation' of excess skin without damaging the
                    basal layer of the dermis, without bleeding and without
                    damage to surrounding tissues. The procedure takes approx.
                    40 minutes.
                  </p>
                  <p>
                    For full patient comfort, we apply a local anesthetic
                    ointment approx. 30 minutes before the procedure. Only
                    slight heat is felt in the treated area. Full eyelid
                    mobility is maintained during and after the eyelid
                    correction procedure. Sublimation points with a diameter of
                    less than 1 mm persist for up to a week.
                  </p>
                  <p>
                    <strong>Treatment advantages:</strong> Minimally invasive
                    (for people who do not want to decide on surgery), precise
                    (micro plasma beam acts only within the epidermis), giving
                    immediate effect (effects visible already after the first
                    treatment), safe (acts locally), comfortable (does not
                    require exclusion from daily activities).
                  </p>
                  <p>
                    <strong>Number and frequency of treatments:</strong> Effects
                    are visible already after the first treatment. However, for
                    best results, it is recommended to perform 2-4 treatments at
                    intervals of at least 40 days.
                  </p>
                  <p>
                    <strong>Effects:</strong> Effects are visible after skin
                    healing. The recovery period lasts from 1.5 weeks to 2
                    weeks.
                  </p>

                  <div className="bg-ui-bg p-5 rounded-xl border border-[#D4AF37] mt-6">
                    <p className="text-sm font-medium text-marble-text mb-3">
                      <strong>PRE-TREATMENT RECOMMENDATIONS:</strong>
                    </p>
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] p-6 md:p-8 gold-glow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      type="text"
                      placeholder="Specify the area exactly (e.g. upper eyelid, lower eyelid, crow's feet...)"
                      ...
                      className="w-full bg-ui-card border border-[#D4AF37]/30 rounded-lg px-4 py-3 text-marble-text placeholder:text-marble-textSecondary/50 focus:border-brand focus:ring-1 focus:ring-brand outline-none transition-colors text-sm"
                    />
                  </div>
                  ...
                  <div className="space-y-3 pt-3 border-t border-[#D4AF37]/30">
                    <p className="text-sm text-marble-text font-medium">
                      Treatment is performed on body part:
                    </p>
                    <input
                      type="text"
                      ...
                      onChange={(e) => {
                        const otherParts = (formData.obszarZabiegu || "")
                          .split(", ")
                          .filter((p) => p && !p.startsWith("body part:"));
                        if (e.target.value) {
                          otherParts.push(`body part: ${e.target.value}`);
                        }
                        handleInputChange(
                          "obszarZabiegu",
                          otherParts.join(", "),
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] p-6 md:p-8 gold-glow-sm">
                ...
                <div className="bg-ui-bg p-5 rounded-xl border border-[#D4AF37] mb-6">
                  ...
                  <label className="block text-sm text-ui-textSecondary mb-2 font-medium">
                    Please list all medications taken within the last 6 months
                  </label>
                  <textarea
                    rows={3}
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] p-6 md:p-8 gold-glow-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-ui-bg p-5 rounded-xl border border-[#D4AF37]">
                    <p className="text-sm font-medium text-marble-text mb-3">
                      POSSIBLE SIDE EFFECTS AFTER THE TREATMENT - FREQUENT
                    </p>
                    <ul className="space-y-2 text-sm text-ui-textSecondary">
                ...
                <div className="bg-ui-bg p-5 rounded-xl border border-[#D4AF37] mb-6">
                  <p className="text-sm text-ui-textSecondary leading-relaxed mb-4">
                    <strong>
                      ...
                      necessity of following these recommendations after the
                      treatment:
                    </strong>
                  </p>
                  <ul className="space-y-2 text-sm text-ui-textSecondary">
                ...
                <div className="p-6 md:p-8">
                  ...
                  <div className="mt-8">
                    ...
                    <p className="text-xs text-marble-textSecondary mt-3 italic">
                      Signing is equivalent to reading the above GDPR
                      information clause.
                    </p>
                  </div>
                </div>
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] gold-glow-sm">
                <div className="p-6 md:p-8">
                  ...
                  <p className="text-sm text-ui-textSecondary mb-4">
                    ...
                    the possibility of natural occurrence of risks:
                  </p>
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] gold-glow-sm">
                <div className="p-6 md:p-8">
                  ...
                  <p className="text-sm text-ui-textSecondary mb-4">
                    I commit to following these recommendations:
                  </p>
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] p-6 md:p-8 gold-glow-sm">
                ...
                <div className="bg-ui-bg p-5 rounded-xl mb-6 border border-[#D4AF37]">
                  <h4 className="font-serif text-marble-text text-lg mb-4">
                    DECLARATION AND INFORMED CONSENT FOR EYELID LIFT TREATMENT
                  </h4>
                  <p className="text-sm text-ui-textSecondary mb-4">
                  ...
                  <div className="space-y-4 text-sm text-ui-textSecondary leading-relaxed">
                    <p>
                      <strong>Health status and awareness:</strong> I have given
                      full and true answers to questions concerning my health. I
                      declare that there are no medical, physical or mental
                      contraindications that could affect my decision. I am
                      aware of the risk of an allergic reaction to the
                      anesthetic agent or the materials used during the
                      procedure. I accept this risk and in case of an allergic
                      reaction, I take responsibility for its consequences. The
                      decision to undergo eyelid lift is made fully consciously,
                      voluntarily and thoughtfully.
                    </p>
                    <p>
                      <strong>Procedure information and hygiene:</strong> I have
                      received exhaustive information about the procedure, its
                      technique, indications and course. I had the opportunity
                      to ask questions and received understandable answers. I
                      confirm that the materials used for the procedure are
                      sterile, disposable and were opened in my presence.
                      Highest hygiene standards are maintained in the Salon.
                    </p>
                    <p>
                      <strong>Risks and complications:</strong> I have been
                      informed about possible side effects such as: swelling,
                      redness, crusts, tenderness, which may persist for several
                      days depending on my lifestyle. I declare that
                      understanding the risk of complications, I will not file
                      compensation claims in case of typical effects of the
                      procedure that I have been warned about.
                    </p>
                    <p>
                      <strong>Effects, durability and no guarantee:</strong> I
                      have been informed that the final effect depends on
                      individual body characteristics (biochemistry, skin type)
                      and the technique applied. I acknowledge that the effects
                      of the procedure are individual, and the procedure should
                      be repeated to maintain the result. I understand that no
                      guarantee is given for achieving an identical effect as in
                      other people, nor for 100% satisfaction with the aesthetic
                      result. Discrepancy between my expectations and the real
                      result (defined by the Specialist as achievable) does not
                      constitute a basis for claims.
                    </p>
                    <p>
                      <strong>Post-treatment recommendations:</strong> I commit
                      to strictly following the post-treatment recommendations
                      that have been given and explained to me. I am aware that
                      failure to follow recommendations may lead to serious
                      complications, such as infections or scarring, for which
                      the Specialist bears no responsibility.
                    </p>
                    <p>
                      ...
                      procedures performed. I accept this fact and in the case
                      of performing the procedure in accordance with principles
                      and ethics of work, and not obtaining the expected effect,
                      I will not file claims against the person performing the
                      procedure.
                    </p>
                    <p className="mt-4 font-medium text-brand">
                      * In case of a minor, signature of a parent or legal
                ...
                <div className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] p-6 md:p-8 mt-8 gold-glow-sm">
                  <h3 className="text-xl font-serif text-marble-text mb-4 border-b border-[#D4AF37] pb-2">
                    Confirmation of Consent to Treatment
                  </h3>
                  <p className="text-sm text-ui-textSecondary mb-6">
                    By signing below, I confirm that I have read the above
                    information, risks, and recommendations and express informed
              ...
              <section className="bg-gradient-emerald rounded-2xl border border-[#D4AF37] p-6 md:p-8 gold-glow-sm">
                ...
                <div className="bg-ui-bg/60 backdrop-blur-sm rounded-xl shadow-sm overflow-hidden border border-brand/50 hover:shadow-md transition-shadow gold-glow-sm">
                  <div className="p-6">
                    ...
                    <p className="text-sm text-ui-textSecondary leading-relaxed mb-6">
                      ...
                      special offers from <strong>{rodoInfo.firmaNazwa}</strong>{" "}
                      electronically (SMS / E-mail).
                    </p>
                    <SignaturePad
                ...
                <div className="bg-ui-bg/60 backdrop-blur-sm rounded-xl shadow-sm overflow-hidden border border-brand/50 hover:shadow-md transition-shadow gold-glow-sm">
                  <div className="p-6">
                    ...
                    <p className="text-sm text-ui-textSecondary leading-relaxed mb-4">
                      I give free consent to the recording and dissemination of
                      my image (photos/video of treatment effects) for
